...
🛠️ Como Usar
Abra a UI Page no ServiceNow.
Informe o nome do Update Set.
Selecione o público (PO ou Dev).
Clique em ⚙️ Gerar Documentação.
Adicione imagens e descrições, se necessário.
Clique em 💾 Exportar PDF para imprimir ou salvar.
📌 Requisitos
